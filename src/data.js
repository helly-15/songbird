  ...
  Warmup: [
    {
      id: 1,
      name: 'Crow',
      description: 'Although outside of captivity crows have not shown probable tool-use, captive crows have shown the ability to use and understand puzzles.',
    ...
    },
    {
      id: 3,
      name: 'Swallow',
      description: 'According to a sailing superstition, swallows are a good omen to those at sea.',
    ...
    },
    {
      ...
      description: 'Nightjars are found around the world except in New Zealand and some islands of Oceania. ',
    ...
    },
    {
      ...
      name: 'Tit',
      species: 'Parus major',
      description: 'The tits are highly adaptable, and after the corvids (crows and jays) and parrots, amongst the most intelligent of all birds',
